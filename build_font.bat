...
set FONT_EXTEND_CHARS=localization\*.txt
...
copy %FONT_EXTEND_CHARS% .\build\font\0x00000080_0xb9e77682.flt
copy %FONT_EXTEND_CHARS% .\build\font\0x00002880_0xa3db960c.flt
copy %FONT_EXTEND_CHARS% .\build\font\0x0000668c_0xb00cd6f8.flt
copy %FONT_EXTEND_CHARS% .\build\font\0x00006f44_0xbd12a6bf.flt

copy %FONT_EXTEND_CHARS% .\build\font\0x00000080_0xc992c4d5.flt
copy %FONT_EXTEND_CHARS% .\build\font\0x000009d4_0x3ddde0c6.flt
copy %FONT_EXTEND_CHARS% .\build\font\0x00001290_0x5e0dd5fc.flt
copy %FONT_EXTEND_CHARS% .\build\font\0x00001b4c_0x0e32aea1.flt

copy %FONT_EXTEND_CHARS% .\build\chars.txt

python fnt.py --height 1024 --width 1024 -c .\build\chars.txt -t build\fonts_jp_discardables\0x00004fe4_0xce14b482.muct -x build\font\%JAP_FNT_TEX%.png -g "path=build\fonts_jp_discardables\0x00000080_0xb9e77682.mfnt:font=%JAPFONT%:size=14:filter=.\build\font\0x00000080_0xb9e77682.flt" "path=build\fonts_jp_discardables\0x00002880_0xa3db960c.mfnt:font=%JAPFONT%:size=20:filter=.\build\font\0x00002880_0xa3db960c.flt" "path=build\fonts_jp_discardables\0x0000668c_0xb00cd6f8.mfnt:font=%JAPFONT%:size=11:filter=.\build\font\0x0000668c_0xb00cd6f8.flt" "path=build\fonts_jp_discardables\0x00006f44_0xbd12a6bf.mfnt:font=%JAPFONT%:size=17:filter=.\build\font\0x00006f44_0xbd12a6bf.flt" --inner-tex-path "system/fonts/textures/japfnt.bctex" --inner-tbl-path "system/fonts/symbols/glyphtablejap.buct"
