...
python fnt.py --height 512 --width 1024 -c %LOC_TXT% -t build\fonts_jp_discardables\0x00004fe4_0xce14b482.muct -x build\font\%JAP_FNT_TEX%.png -g "path=build\fonts_jp_discardables\0x00000080_0xb9e77682.mfnt:font=%JAPFONT%:size=14:filter=.\font\0x00000080_0xb9e77682.flt" "path=build\fonts_jp_discardables\0x00002880_0xa3db960c.mfnt:font=%JAPFONT%:size=20:filter=.\font\0x00002880_0xa3db960c.flt" "path=build\fonts_jp_discardables\0x0000668c_0xb00cd6f8.mfnt:font=%JAPFONT%:size=11:filter=.\font\0x0000668c_0xb00cd6f8.flt" "path=build\fonts_jp_discardables\0x00006f44_0xbd12a6bf.mfnt:font=%JAPFONT%:size=17:filter=.\font\0x00006f44_0xbd12a6bf.flt" --inner-tex-path "system\fonts\textures\japfnt.bctex" --inner-tbl-path "system\fonts\symbols\glyphtablejap.buct"
...
python fnt.py --height 512 --width 1024 -c %LOC_TXT% -t build\fonts_discardables\0x00002408_0x03c07881.muct -x build\font\%DEF_FNT_TEX%.png -g "path=build\fonts_discardables\0x00000080_0xc992c4d5.mfnt:font=%DEFFONT%:size=14:filter=.\font\0x00000080_0xc992c4d5.flt" "path=build\fonts_discardables\0x000009d4_0x3ddde0c6.mfnt:font=%DEFFONT%:size=10:filter=.\font\0x000009d4_0x3ddde0c6.flt" "path=build\fonts_discardables\0x00001290_0x5e0dd5fc.mfnt:font=%DEFFONT%:size=16:filter=.\font\0x00001290_0x5e0dd5fc.flt" "path=build\fonts_discardables\0x00001b4c_0x0e32aea1.mfnt:font=%DEFFONT%:size=17:filter=.\font\0x00001b4c_0x0e32aea1.flt" --inner-tex-path "system\fonts\textures\defaultfnt.bctex" --inner-tbl-path "system\fonts\symbols\glyphtable.buct"
